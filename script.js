...
for(var i=0;i<n;i++){
	kal[i]=kalimat[i].split(" ");
}

function out1(str){
	document.getElementById('box').innerHTML="";
	for(var i=0;i<n;i++){
		document.getElementById('box').innerHTML+=(str[i]+"<br>");
	}
}
...
function out2(str){
	document.getElementById('box').innerHTML="";
	for(var i=0;i<n;i++){
		document.getElementById('box').innerHTML+=((i+1)+" "+str[i]+"<br>");
	}
}

function out3(str){
	document.getElementById('box').innerHTML="";
	document.getElementById('box').innerHTML=("Kata baris 1 = "+str[0].length+"<br>"+"Kata baris -1 = "+str[n-1].length);
}